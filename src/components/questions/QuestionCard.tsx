...
export const QuestionCard = ({
  ...
  const shouldShowAnswers =
    examType === "study" ? answerChecked : examType === "test" && showAnswers;
      ...
      <CardContent>
        ...
        <div className="space-y-2">
          {question.options.map((option) => {
            ...
            const showCorrectness =
              shouldShowAnswers && (isAnswered || answerChecked);
        ...
        <div className="mt-4 flex flex-wrap gap-2 justify-between">
          ...
          {question.explanation &&
            (shouldShowAnswers || examType === "study") && (
              <Button
                variant="outline"
                size="sm"
        ...
        {showExplanation && question.explanation && (
          <div className="mt-4 p-4 bg-secondary rounded-md">
            ...
            <div
              className="text-sm prose prose-sm max-w-none remirror-theme remirror-editor rich-text-content"
              dangerouslySetInnerHTML={{
                __html: normalizeHTML(question.explanation),
              }}
            />
          </div>
        )}
